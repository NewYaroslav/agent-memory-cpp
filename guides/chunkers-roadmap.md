...
- `E:\_repoz\ai-agent-playbook\resources\rag-knowledge\ЮMoney Юджин корпоративный RAG на FRIDA и Milvus - разбор статьи.md` — production case с 5 format-specialized чанкерами.
- `E:\_repoz\ai-agent-playbook\concepts\rag-knowledge\Local RAG для проприетарного API - паттерн декомпиляции и карточки сущности.md` — entity-card chunking для decompiled code.
- `E:\_repoz\ai-agent-playbook\playbooks\rag-knowledge\Legal-RAG - структурный чанкинг по статьям и пунктам.md` — structural chunker для НПА с citations и UUID5.
- `E:\_repoz\ai-agent-playbook\playbooks\rag-knowledge\Docling RAG Agent — шаблон для обработки любых форматов.md` — Docling как multimodal chunker.
- `E:\_repoz\ai-agent-playbook\concepts\rag-knowledge\Contextual Retrieval — LLM-обогащение чанков контекстом документа.md` — Anthropic chunk-enrichment.
- `E:\_repoz\ai-agent-playbook\playbooks\rag\Contextual Retrieval — индексация production-RAG с Haiku + prompt caching.md` — production playbook.
- `E:\_repoz\ai-agent-playbook\resources\n8n-automation\Метод улучшения RAG от Anthropic - Контекстуализация в n8n - расшифровка.md` — реализация без Python в n8n + Qdrant.
- `E:\_repoz\ai-agent-playbook\playbooks\rag\RAG через Q-A пары — альтернатива загрузке PDF.md` — Q-A pairs as chunking alternative.
...
[Source: `E:\_repoz\ai-agent-playbook\resources\rag-knowledge\ЮMoney Юджин корпоративный RAG на FRIDA и Milvus - разбор статьи.md`]
...
Источник — ЮMoney production case [Source: `E:\_repoz\ai-agent-playbook\resources\rag-knowledge\ЮMoney Юджин корпоративный RAG на FRIDA и Milvus - разбор статьи.md`]:
...
Источник: `E:\_repoz\ai-agent-playbook\playbooks\rag-knowledge\Legal-RAG - структурный чанкинг по статьям и пунктам.md`.
...
Источник: `E:\_repoz\ai-agent-playbook\concepts\rag-knowledge\Local RAG для проприетарного API - паттерн декомпиляции и карточки сущности.md` и `E:\_repoz\ai-agent-playbook\playbooks\rag-knowledge\Local RAG build pipeline - decompile enrich bge-m3 agent manifest.md`.
...
Источник: `E:\_repoz\ai-agent-playbook\playbooks\rag-knowledge\Docling RAG Agent — шаблон для обработки любых форматов.md`.
...
Источник: `E:\_repoz\ai-agent-playbook\concepts\rag-knowledge\Contextual Retrieval — LLM-обогащение чанков контекстом документа.md`.
...
Из `E:\_repoz\ai-agent-playbook\concepts\rag-knowledge\11 RAG стратегий — спектр и комбинации.md`:
...
Из `E:\_repoz\ai-agent-playbook\playbooks\rag\RAG через Q-A пары — альтернатива загрузке PDF.md`:
...
Источник: `E:\_repoz\ai-agent-playbook\resources\rag-knowledge\ЮMoney Юджин корпоративный RAG на FRIDA и Milvus - разбор статьи.md`.
...
- `E:\_repoz\ai-agent-playbook\resources\rag-knowledge\ЮMoney Юджин корпоративный RAG на FRIDA и Milvus - разбор статьи.md` — production case с 5 format-specialized chunkers (OpenAPI / Markdown / AsciiDoc / PlantUML / HTML).

**Domain-specialized:**

- `E:\_repoz\ai-agent-playbook\concepts\rag-knowledge\Local RAG для проприетарного API - паттерн декомпиляции и карточки сущности.md` — entity-card pattern, «только подтверждённые факты».
- `E:\_repoz\ai-agent-playbook\playbooks\rag-knowledge\Local RAG build pipeline - decompile enrich bge-m3 agent manifest.md` — 7-шаговый pipeline для decompiled code.
- `E:\_repoz\ai-agent-playbook\playbooks\rag-knowledge\Legal-RAG - структурный чанкинг по статьям и пунктам.md` — НПА structural chunker, citations, UUID5, OCR.
- `E:\_repoz\ai-agent-playbook\playbooks\rag-knowledge\Docling RAG Agent — шаблон для обработки любых форматов.md` — Docling multimodal.

**Context enrichment:**

- `E:\_repoz\ai-agent-playbook\concepts\rag-knowledge\Contextual Retrieval — LLM-обогащение чанков контекстом документа.md` — Anthropic 49-67% reduction, $0.50/1000 chunks, prompt caching.
- `E:\_repoz\ai-agent-playbook\playbooks\rag\Contextual Retrieval — индексация production-RAG с Haiku + prompt caching.md` — production playbook.
- `E:\_repoz\ai-agent-playbook\resources\n8n-automation\Метод улучшения RAG от Anthropic - Контекстуализация в n8n - расшифровка.md` — реализация через n8n + Qdrant + Haiku 3.5.

**Two-stage / reverse Q-A:**

- `E:\_repoz\ai-agent-playbook\playbooks\rag\RAG через Q-A пары — альтернатива загрузке PDF.md` — Q-A pairs как альтернатива.
- `E:\_repoz\ai-agent-playbook\resources\rag-knowledge\ЮMoney Юджин корпоративный RAG на FRIDA и Milvus - разбор статьи.md` — two-stage indexing (chunks + synthetic questions).

**Survey / typology:**

- `E:\_repoz\ai-agent-playbook\concepts\rag-knowledge\11 RAG стратегий — спектр и комбинации.md` — Context-Aware Chunking vs Late Chunking vs Fine-tuned Embeddings.
- `E:\_repoz\ai-agent-playbook\concepts\rag-knowledge\Типы RAG - от Naive до Agentic.md` — typology по сложности реализации.
